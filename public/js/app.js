...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_ProductList__ = __webpack_require__(41);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_MyCart__ = __webpack_require__(47);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__event_bus_js__ = __webpack_require__(5);
//
//
//
//
...
var update = __webpack_require__(14)("27c7c402", content, false, {});
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(14)("255087ac", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
    ...
    methods: {
        ...
        removeItem: function removeItem() {
            ...
            __WEBPACK_IMPORTED_MODULE_0_axios___default.a.delete('api/mycart/' + this.itemDelete.id).then(function (res) {
                ...
                _this2.totalString = _this2.total.toLocaleString('en');
